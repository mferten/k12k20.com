...
function eWorldGlobalSetup() {
    importAnExternalJSFile("id_Searching", "js/globalVersion002.js", "Searching", false); // import a javascript external file
}

function eWorldRegionalSetup() {
    importAnExternalJSFile("id_Surfing", "js/regionalVersion003.js", "Surfing", false); // import a javascript external file
}

function eWorldCountriesSetup() {
    importAnExternalJSFile("id_Countries", "js/countryCodesSetupVersion003.js", "CountryCodes", false); // import a javascript external file
}

function eWorldStartupSetup(  ) {
    importAnExternalJSFile("id_Register", "js/registerSetupVersion003.js", "Register", true); // import a javascript external file
}

function eWorldCitationsSetup() {
    importAnExternalJSFile("id_Citations", "js/citationsVersion003.js", "Citations", true); // import a javascript external file
}

function eWorldAboutSetup() {
    importAnExternalJSFile("id_AboutMe", "js/aboutMeVersion003.js", "AboutMe", true); // import a javascript external file
}

function eWorldTextLanguagesSetup() {
    importAnExternalJSFile("id_TextLanguages", "js/textLanguagesVersion003.js", "TextLanguages", true); // import a javascript external file
}

function eWorldDataLanguagesSetup() {
    importAnExternalJSFile("id_DataLanguages", "js/dataLanguagesVersion003.js", "DataLanguages", true); // import a javascript external file
}
